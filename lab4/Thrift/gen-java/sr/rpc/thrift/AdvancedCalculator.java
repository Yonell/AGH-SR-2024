  ...
  public static class op_args implements org.apache.thrift.TBase<op_args, op_args._Fields>, java.io.Serializable, Cloneable, Comparable<op_args>   {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.val = new java.util.HashSet<java.lang.Double>(2*_set8.size);
                  double _elem9;
                  for (int _i10 = 0; _i10 < _set8.size; ++_i10)
                  {
                    _elem9 = iprot.readDouble();
                    struct.val.add(_elem9);
                  }
                  iprot.readSetEnd();
                }
    ...
    private static class op_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<op_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, op_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(1)) {
          {
            org.apache.thrift.protocol.TSet _set13 = iprot.readSetBegin(org.apache.thrift.protocol.TType.DOUBLE);
            struct.val = new java.util.HashSet<java.lang.Double>(2*_set13.size);
            double _elem14;
            for (int _i15 = 0; _i15 < _set13.size; ++_i15)
            {
              _elem14 = iprot.readDouble();
              struct.val.add(_elem14);
            }
          }
          struct.setValIsSet(true);
        }
