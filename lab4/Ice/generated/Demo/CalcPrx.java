...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default double avg(long[] a)
        throws EmptySequence
    {
        return avg(a, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default double avg(long[] a, java.util.Map<String, String> context)
        throws EmptySequence
    {
        try
        {
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Double> avgAsync(long[] a)
    {
        return _iceI_avgAsync(a, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Double> avgAsync(long[] a, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> _iceI_avgAsync(long[] iceP_a, java.util.Map<String, String> context, boolean sync)
    {
