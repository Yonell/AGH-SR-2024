...
if 'cofeeType' not in _M_home.__dict__:
    _M_home.cofeeType = Ice.createTempClass()
    class cofeeType(Ice.EnumBase):
    ...
    cofeeType.ESPRESSO = cofeeType("ESPRESSO", 0)
    cofeeType.AMERICANO = cofeeType("AMERICANO", 1)
    cofeeType.CAPPUCCINO = cofeeType("CAPPUCCINO", 2)
    cofeeType.LATTE = cofeeType("LATTE", 3)
    cofeeType._enumerators = { 0:cofeeType.ESPRESSO, 1:cofeeType.AMERICANO, 2:cofeeType.CAPPUCCINO, 3:cofeeType.LATTE }

    _M_home._t_cofeeType = IcePy.defineEnum('::home::cofeeType', cofeeType, (), cofeeType._enumerators)

    _M_home.cofeeType = cofeeType
    del cofeeType

if '_t_CofeeSeq' not in _M_home.__dict__:
    _M_home._t_CofeeSeq = IcePy.defineSequence('::home::CofeeSeq', (), _M_home._t_cofeeType)
...
if 'CoffeeMachinePrx' not in _M_home.__dict__:
    ...
    CoffeeMachine._op_makeCoffee = IcePy.Operation('makeCoffee', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_home._t_cofeeType, False, 0),), (), None, (_M_home._t_Busy,))
    CoffeeMachine._op_makeCoffees = IcePy.Operation('makeCoffees', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_home._t_CofeeSeq, False, 0),), (), None, (_M_home._t_Busy,))
